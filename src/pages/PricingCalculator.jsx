...
/**
 * Full-page pricing calculator — served at /pricing-calculator.
 * All the quote logic that was previously inline in Pricing.jsx lives here,
 * so the homepage never pulls in the calculator bundle.
 */
export default function PricingCalculator() {
  ...
  /* Send quote → navigate back to homepage contact form with the message. */
  const handleSend = useCallback(() => {
    ...
    window.location.href = `/?sendQuote=1&${params.toString()}#contact`
  }, [])
  ...
  return (
    <div className="grid-matrix min-h-screen">
      <div
        aria-hidden="true"
      ...
      {/* ── Main content ─────────────────────────────────────────── */}
      <main className="mx-auto max-w-[1240px] px-5 pb-16 pt-36 sm:px-8 sm:pt-40">
        {/* Heading */}
        <div className="mx-auto max-w-2xl text-center">
          <p className="inline-flex items-center gap-2 font-mono text-[11px] tracking-[0.2em] text-signal uppercase">
            <span aria-hidden="true" className="h-px w-6 bg-signal" />
            Instant estimate
            <span aria-hidden="true" className="h-px w-6 bg-signal" />
          </p>
          <h1 className="mt-4 font-display text-[2.2rem] leading-[1.1] font-semibold sm:text-[2.8rem]">
            Build your project, get a{' '}
            <GradientText italic>price &amp; timeline</GradientText>.
          </h1>
          <p className="mt-4 text-[15.5px] leading-relaxed text-body">
            Pick what you need — the price and timeline update instantly. Save the quote
            as a PDF, or send it straight to our team.
          </p>
        </div>
        ...
        <div className="mt-6 grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_22rem]">
          ...
          <aside
            ...
            className="rounded-2xl border border-rule bg-snow-raised p-5 shadow-lift-lg sm:p-6 lg:sticky lg:top-24"
          >
